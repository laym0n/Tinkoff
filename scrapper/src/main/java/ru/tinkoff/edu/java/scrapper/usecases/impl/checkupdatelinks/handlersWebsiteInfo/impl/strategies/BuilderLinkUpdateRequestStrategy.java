...
public interface BuilderLinkUpdateRequestStrategy<T extends WebsiteInfo, R extends WebsiteResponse> {
    LinkUpdateRequest buildLinkUpdateRequest(ResultOfCompareWebsiteInfo<T, R> changes, int[] chatIds);
}
